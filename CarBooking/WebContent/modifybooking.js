    ...
    function GetDayBooking() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function (key1, value1) {
                    $.each(value1, function (key2, value2) {
                        row += ('<tr><td align="center">' +
                                ...
                                '<input type="button" id="modificaprenotazione" class="modificaprenotazione" value="Modifica"/>' +
                                '</td></tr>');
                    });
                ...
                $('.modificaprenotazione').click(function() {
                	var id = ($(this).closest('tr').find('td.id').text());
                    window.location = 'updatebooking.html?Id=' + id;
                });
