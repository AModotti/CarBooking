$(document).ready(function() {
    ...
    GetActualDateInsertBooking();
    
    function GetActualDateInsertBooking(){
        var dagiorno = GetUrlParameter('dagiorno');
        var agiorno = GetUrlParameter('agiorno');
        $.ajax({
        url: "GetActualDateInsertBooking",
            dataType: "json",
            async: false,
            data:{dagiorno: dagiorno,
            	   agiorno: agiorno
                 },
