    ...
    function GetDayBooking() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('.eliminaprenotazione').bind("click", DeleteDayBooking);
    ...
    function GetWeekBooking() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('.eliminaprenotazione').bind("click", DeleteWeekBooking);
                $("tr:odd").css("background-color", "whyte");
                $("tr:even").css("background-color", "lightgray");
            }
        });
    ...
    function GetMonthBooking() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('.eliminaprenotazione').bind("click", DeleteMonthBooking);
                $("tr:odd").css("background-color", "whyte");
                $("tr:even").css("background-color", "lightgray");
            }
        });
